...
SRC_URI="x86?   ( https://download-cdn.getsyncapp.com/stable/linux-i386/BitTorrent-Sync_i386.tar.gz -> ${P}-x86.tar.gz )
		 amd64? ( https://download-cdn.getsyncapp.com/stable/linux-x64/BitTorrent-Sync_x64.tar.gz   -> ${P}-amd64.tar.gz )"
